...
```{r, echo = -1}
supressWarnings(suppressPackageStartupMessages(library(EnrichedHeatmap)))
...
If you split the rows in the heatmap, graphic parameters can still be set as a vector.
