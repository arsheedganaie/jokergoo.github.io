...
"</div>\n",
"\n<p style='border-top:1px dotted #CCCCCC;text-align:right;margin-top:10px;font-size:0.8em'><a href='rss.xml' style='color:#CCCCCC;font-weight:normal'>RSS</a></p>\n",
footer)
...
html = c(header,
{
	...
	for(i in order(post_info$create_time, decreasing = TRUE)) {
		...
		blog_body = gsub("<img src=\"data:image.*?>", "<i>Please see the figure in the original post.</i>", blog_body)
